...
async function handler(req, res) {
  ...
  if (!body.fullname || !body.tel || !body.email || !body.address ||!body.treats ||!body.sample ||!body.pouch || !body.order)  {
  ...
  const response = await sheets.spreadsheets.values.append({
    ...
    requestBody: {
      values: [[body.fullname, body.tel, body.email, body.address, body.treats, body.sample, body.pouch, body.order]],
    },
  });

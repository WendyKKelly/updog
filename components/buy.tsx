...
<h4 className={grandstander.className}>
 ...
 <h5 className={grandstander.className}>How To Get Your Dog Treats:</h5>
            ...
            <div className={styles.button}><a href={`mailto:${'updogtreatsplease@gmail.com?Subject=Updog%20Treats%20Please'}`}><h5 className={grandstander.className}>Email Updog</h5></a></div> 
